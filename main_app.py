...
if st.session_state.history:
    for idx, entry in enumerate(reversed(st.session_state.history)):
        st.write(f"### Query {len(st.session_state.history) - idx}")
        st.write(f"**Original Query:** {entry['query']}")
        st.write(f"**Rewritten Query:** {entry['rewritten_query']}")
        st.write(f"**Hypothetical Document:** {entry['hypothetical_document']}")
